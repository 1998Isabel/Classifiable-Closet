...
def callduinorotate(mode):
    if mode == 1:
        print('Degree is 50L. It is shirt!')
        s1.write(b'deg0\n')
        sleep(3)
        s1.write(b'deg50\n')
        sleep(3)
        ...
        print('Degree is 110L. It is shorts!')
        s1.write(b'deg0\n')
        sleep(3)
        s1.write(b'deg110\n')
        sleep(3)
        ...
        print('Degree is 170L. It is coat!')
        s1.write(b'deg0\n')
        sleep(3)
        s1.write(b'deg170\n')
        sleep(3)
        ...
        print('Degree is 50R. It is long-sleeves!')
        s1.write(b'deg180\n')
        sleep(3)
        s1.write(b'deg50\n')
        sleep(3)
        ...
        print('Degree is 110R. It is pants!')
        s1.write(b'deg180\n')
        sleep(3)
        s1.write(b'deg110\n')
        sleep(3)
...
labellist=['Shirt', 'Shorts', 'Coat', 'Long Sleeve', 'Pants']
